...
//		tf1 = new JTextField(bean.getTraderAcc1(), 15);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj==UpBtn/*?ˆ˜? •ë²„íŠ¼*/) {
			...
			if(mgr.update(bean)) {
				check = new DialogBox(null, "?ˆ˜? •?´ ?™„ë£Œë˜?—ˆ?Šµ?‹ˆ?‹¤.", "?™•?¸");
