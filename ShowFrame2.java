...
//		tf1 = new JTextField(bean.getTraderAcc1(), 15);
       ...
       totalTextField.setText("?ïΩ " + TAmount + " ?õê");
	    ...
	    p8.add(new JLabel("ÍµêÌôò ?ôî?èê :"));
		...
		p9.add(new JLabel("ÍµêÌôò ?àò?üâ  :"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj==AplBtn/*ÍµêÌôò?ã†Ï≤?*/) {
			...
			System.out.println("Î≤ÑÌäº ?àåÎ¶?");
            trade2.removeAll();
            JScrollPane scrollPane = new JScrollPane(); // JScrollPane ?Éù?Ñ±
